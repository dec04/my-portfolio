...
class WorkContainer extends Component {
    ...
    render() {
        const row = (item, k) => !!item ?
                <div className="row my-lg-5 py-lg-5 mb-5 d-flex align-items-stretch" id={`scene-${k}`} key={k}>
                    ...
                    <div className={`col-12 col-lg-6 d-flex justify-content-center flex-column ${k % 2 ? "order-lg-1" : ""}`}>
                        <div id={`work-header-scene-${k}`}
                             ...
                             data-relative-input="true">
                            <h2 data-depth=".08"
                                className="header mb-4 mt-4 mt-lg-0 text-center text-lg-left">{item.header}</h2>
                        </div>
